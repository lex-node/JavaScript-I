...
console.log(`Car 33 is a ${inventory[inventory.length - 1].car_make} ${inventory[inventory.length - 1].car_model}`);
...
//verifies that alphabetically sorted array is same length as inventory array  to ensure there are no missing entries
...
//logs the array of years
console.log(carYears);

//verifies that  array is same length as inventory array  to ensure there are no missing entries
console.log(carYears.length === inventory.length);
